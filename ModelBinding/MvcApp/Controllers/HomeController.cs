...
namespace MvcApp.Controllers {
    ...
    public class HomeController : Controller {
        ...
        public ActionResult Index() {
            ...
            return RedirectToAction("show", new { id = "1",  person="afas"});
          //  return View("PersonEdit", myPerson);
        }
        public ActionResult show(string id,Person person)
        {
        ...
        [HttpPost]
        public ActionResult RegisterMember1([Bind( Prefix="newPerson")]Person person)
        {
